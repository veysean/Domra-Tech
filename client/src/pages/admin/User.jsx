...
const UserPage = () => {
  ...
  const handleEdit = (user) => {
    alert(`Editing ${user.firstName} ${user.lastName}`);
  };
        ...
        <table className="w-full border border-none rounded-lg shadow-sm overflow-hidden">
          ...
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-4 py-4 text-left text-gray-700 font-semibold">Password</th>
          ...
          <tbody>
            {filteredUsers.length > 0 ? (
              ...
              <tr key={user.userId} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-4 border-b border-gray-200 text-gray-600">{user.password}</td>
