    ...
    return (
        ...
        <div className="w-full h-auto lg:h-[312px] bg-[#F8F9FA] overflow-hidden flex flex-col justify-center items-center pl-5 lg:pl-0 pt-5 lg:pt-0">
            ...
            <div className="w-full lg:w-[451px] flex flex-col items-start">
                ...
                <div className="w-[30px] h-[30px]" onClick={() => window.open("https://github.com/veysean/Domra-Tech.git", "_blank")}>
                    <svg  className="lg:w-[31px] lg:h-[30px] w-[25px] h-[24px] cursor-pointer"  viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
