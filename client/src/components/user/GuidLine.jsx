...
export default function GuidLine() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-10 flex flex-col rounded-2xl border border-slate-200 justify-center items-center gap-8 hover:shadow-lg transition-shadow duration-300">
      {/* Header */}
      <div className="text-center gradient-text text-2xl sm:text-3xl md:text-4xl font-extrabold">
        {t('guideline')}
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-6 w-full">
        ...
        <div className="flex-1 flex flex-col gap-4 md:gap-6">
          <div className="pl-4 border-l-4 border-indigo-500 flex flex-col gap-2">
            <div className="text-indigo-500 text-xl sm:text-2xl font-bold">
              {steps[step - 1].title}
            </div>
            <div className="text-indigo-500 text-base sm:text-lg md:text-xl font-normal">
              {steps[step - 1].desc}
            </div>
          </div>
        </div>
