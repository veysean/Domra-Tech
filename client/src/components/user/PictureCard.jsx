...
const PictureCard = ({ imageSrc, name, role }) => {
  return (
    ...
    <div className="self-stretch h-20 flex flex-col justify-start items-center gap-2.5">
        <div className="text-center text-indigo-500 lg:text-xl font-medium font-['Inter']">{name}</div>
        <div className="text-center text-slate-600 lg:text-xl font-normal font-['Inter']">{role}</div>
    </div>
</div>
  );
};
