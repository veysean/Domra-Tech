...
const PictureCard = ({ imageSrc, name, role }) => {
  return (
    <div data-property-1="Default" className=" p-5 bg-white rounded-[20px] outline-1 outline-offset-[-1px] outline-slate-200 inline-flex flex-col justify-center items-center gap-5 ">
