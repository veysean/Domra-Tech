                ...
                <div data-property-1="Default" className="w-[565px] p-9 bg-white rounded-[20px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] flex flex-col justify-start items-start gap-7 hover:shadow-[0px_8px_8px_0px_rgba(0,0,0,0.25)]">
                    ...
                    <div className="self-stretch pt-7 border-t border-slate-200 inline-flex justify-between items-start">
                        ...
                        <button
                            ...
                            className="h-10 px-2.5 py-5 bg-green-600 rounded-[20px] outline-1 outline-offset-[-1px] outline-slate-200 flex justify-center items-center gap-2.5 hover:bg-green-700"
                        >
                            <div className="w-4 h-4 relative">
