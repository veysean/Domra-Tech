                    ...
                    <div className="lg:flex justify-between  items-center w-full max-w-[1200px]">
                        ...
                        <div className="relative">
                            ...
                            <button
                                ...
                                className="w-[90px] h-[32px] md:h-[36px] lg:w-[113px] lg:h-[44px] bg-[#F8F9FA] rounded-[30px] outline-[1px] outline-[#3F51B5] outline-offset-[-1px] flex justify-center items-center"
                            >
                                <div className="flex justify-center items-center">
                                    <div className="flex justify-center items-center ">
                                        ...
                                        <div className="w-[40px] lg:w-[55px] text-[#3F51B5]/80 text-base lg:text-[20px] font-semibold font-inter"> {language} </div>
                                    </div>
                            ...
                            {isLangOpen && (
                                ...
                                {["ENG", "ខ្មែរ"].map((lang) => (
                                    ...
                                    className="px-5 py-2.5 text-[#3F51B5] text-base lg:text-[20px] font-semibold font-inter hover:bg-gray-100 cursor-pointer flex justify-between items-center border-t first:border-t-0 border-[#E2E8F0]"
                                    >
                                    {lang}
                                    {language === lang && (
