...
export default function SearchBar({ onSearchChange, onSearchSubmit, onSearchFocus }) {
  ...
  return (
    <div className="sm:w-full w-full lg:self-stretch h-12 lg:h-16 p-5 rounded-[30px] outline-1 outline-offset-[-1px] outline-slate-200 inline-flex flex-col justify-center items-start gap-5​ hover:outline-[#667EEA]">
